    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesEndpoints", x => new { x.RoleId, x.EndpointId });
                    table.ForeignKey(
                        name: "FK_RolesEndpoints_Endpoints_EndpointId",
                        column: x => x.EndpointId,
                        principalTable: "Endpoints",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RolesEndpoints_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolesEndpoints_EndpointId",
                table: "RolesEndpoints",
                column: "EndpointId");
